...
FLAGS = flags.FLAGS
flags.DEFINE_string('rollout_path', 'data/rollout_flagsimple_n50w.pkl', 'Path to rollout pickle file')
flags.DEFINE_enum('mode', 'pred', ['gt', 'pred'], 'Output groundtruth or prediction results')
...
def main(unused_argv):
  ...
  def animate(num):
    ...
    if traj < FLAGS.num_rollouts:
      ...
      if FLAGS.mode == 'gt':
          pos = rollout_data[traj]['gt_pos'][step]
